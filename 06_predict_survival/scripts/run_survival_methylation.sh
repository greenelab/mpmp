...
for seed in 42 1; do
    ...
    # results_dir=./06_predict_survival/results/me_baseline/results_baseline/
    ...
    for n_dim in 10 100; do

    #     # raw data
    #     results_dir=./06_predict_survival/results/me_ridge/results_${n_dim}_raw/
