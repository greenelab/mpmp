...
# TODO: put directory information in a config file
data_dir = '../data'
...
me_filepath = os.path.join(data_dir, me_filename)
...
rppa_filepath = os.path.join(data_dir, rppa_filename)
...
mirna_filepath = os.path.join(data_dir, mirna_filename)
